...
def login_user(request):
    '''Handles the authentication of a card_holder
...
def register_user(request):
    '''Handles the creation of a new card_holder for authentication
    ...
    token = Token.objects.create(user=card_holder.user)
